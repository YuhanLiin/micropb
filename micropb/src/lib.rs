...
//!
//! **For info on the generated code, see [`micropb-gen`](https://docs.rs/micropb-gen/latest/micropb-gen).**
//!
//! # Decoder and Encoder
//!
...
//! // Or, encode directly to the data stream
//! message.encode_to_writer(&mut output).unwrap();
//! ```
//!
//! # Container Traits
//!
...
//! [`micropb-gen` docs](https://docs.rs/micropb-gen/latest/micropb-gen#repeated-map-string-and-bytes-fields).
//!
//! # Feature Flags
//!
